...
namespace MIG.Game.Shooting
{
    ...
    ""controlSchemes"": [
        ...
        ~@ShootingControls()
        {
            Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ShootingControls.Player.Disable() has not been called.");
        }
        ...
        public struct PlayerActions
        {
            ...
            public PlayerActions(@ShootingControls wrapper) { m_Wrapper = wrapper; }
